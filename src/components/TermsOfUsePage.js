    ...
    <div className="legal-page">
      <div className="legal-content">
        ...
        <div className="legal-header">
          ...
          <p className="legal-subtitle">Last Updated and effective: July 29th, 2024</p>
        </div>

        <div className="legal-body">
          <section className="legal-section">
            <p>
              Please review the following Terms of Use (the "Terms"), which govern your use of smartautoinsider.com (the "Site", "we", "us", or "our"). By using the site, you agree to follow and be bound by these Terms of Use. We reserve the right to update or modify these Terms at any time without prior notice. For this reason, we encourage you to review these Terms each time you use the Site. If you do not agree to these Terms, please do not use the Site.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              By using the Site, you agree to the terms of our Privacy Policy, which you can access here. (Link to PP)
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Vision Media Group's Copyright Agent for notice of claims of copyright infringement on Vision Media Group can be reached at: privacy@smartautoinsider.com
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Please send us an email at privacy@smartautoinsider.com or write to: 1041 N Dupont Hwy #1575, Dover, DE 19901 if you have any questions, comments, or concerns relating to our website, these Terms, or our Privacy Policy.
            </p>
          </section>
        </div>
      </div>
